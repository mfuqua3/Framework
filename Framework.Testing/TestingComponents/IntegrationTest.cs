...
using Framework.Testing.TestingComponents.Infrastructure;
...
public abstract class IntegrationTest
{
    ...
    protected ReplaceMeDatabaseAccess OpenSession() =>
        GetCurrentExecutionScope().OpenSession(new ReplaceMeDatabaseOptions());
